...
// node_modules/gifshot/dist/gifshot.js
var require_gifshot = __commonJS({
  "node_modules/gifshot/dist/gifshot.js"(exports, module) {
    (function(window2, document2, navigator, undefined) {
      "use strict";
      var utils = {
      ...
      AnimatedGIF.prototype = {
        ...
        generateGIF: function generateGIF(frames, callback) {
          ...
          var existingImages2 = options.images;
      ...
      var videoStream = {
        ...
        startStreaming: function startStreaming(obj) {
          ...
          var crossOrigin = obj.crossOrigin, existingVideo2 = obj.existingVideo, lastCameraStream = obj.lastCameraStream, options = obj.options, webcamVideoElement = obj.webcamVideoElement;
      ...
      function existingVideo() {
        var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        var callback = obj.callback, existingVideo2 = obj.existingVideo, options = obj.options;
        var skipObj = {
          getUserMedia: true,
          "window.URL": true
        };
      ...
      function existingWebcam() {
        ...
        videoStream.startVideoStreaming(function() {
          var obj2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          obj2.options = options || {};
          createAndGetGIF(obj2, callback);
        }, {
          lastCameraStream,
...
export default require_gifshot();
